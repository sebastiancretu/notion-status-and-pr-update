...
const getInputs = () => {
    ...
    const context = {
        payload: {
            ...
            number: 42,
            organization: {
                avatar_url: 'https://avatars.githubusercontent.com/u/37342643?v=4',
                description: 'Smart Navigation for Electric Mobility',
                events_url: 'https://api.github.com/orgs/chargetrip/events',
                hooks_url: 'https://api.github.com/orgs/chargetrip/hooks',
                id: 37342643,
                issues_url: 'https://api.github.com/orgs/chargetrip/issues',
                login: 'chargetrip',
                members_url: 'https://api.github.com/orgs/chargetrip/members{/member}',
                node_id: 'MDEyOk9yZ2FuaXphdGlvbjM3MzQyNjQz',
                public_members_url: 'https://api.github.com/orgs/chargetrip/public_members{/member}',
                repos_url: 'https://api.github.com/orgs/chargetrip/repos',
                url: 'https://api.github.com/orgs/chargetrip',
            },
            pull_request: {
                _links: {
                    comments: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/42/comments',
                    },
                    commits: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42/commits',
                    },
                    html: {
                        href: 'https://github.com/chargetrip/chargetrip-backend-e2e/pull/42',
                    },
                    issue: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/42',
                    },
                    review_comment: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/comments{/number}',
                    },
                    review_comments: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42/comments',
                    },
                    self: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42',
                    },
                    statuses: {
                        href: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/statuses/9295350e75b01bd7a1d8e0c3dd2b10650b583679',
                    },
                },
                ...
                base: {
                    ...
                    repo: {
                        ...
                        archive_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/{archive_format}{/ref}',
                        archived: false,
                        assignees_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/assignees{/user}',
                        blobs_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/git/blobs{/sha}',
                        branches_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/branches{/branch}',
                        clone_url: 'https://github.com/chargetrip/chargetrip-backend-e2e.git',
                        collaborators_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/collaborators{/collaborator}',
                        comments_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/comments{/number}',
                        commits_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/commits{/sha}',
                        compare_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/compare/{base}...{head}',
                        contents_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/contents/{+path}',
                        contributors_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/contributors',
                        created_at: '2022-09-14T09:21:47Z',
                        default_branch: 'main',
                        delete_branch_on_merge: true,
                        deployments_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/deployments',
                        description: 'Chargetrip API End-To-End tests using cucumber-js',
                        disabled: false,
                        downloads_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/downloads',
                        events_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/events',
                        fork: false,
                        forks: 0,
                        forks_count: 0,
                        forks_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/forks',
                        full_name: 'chargetrip/chargetrip-backend-e2e',
                        git_commits_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/git/commits{/sha}',
                        git_refs_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/git/refs{/sha}',
                        git_tags_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/git/tags{/sha}',
                        git_url: 'git://github.com/chargetrip/chargetrip-backend-e2e.git',
                        ...
                        has_wiki: true,
                        homepage: null,
                        hooks_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/hooks',
                        html_url: 'https://github.com/chargetrip/chargetrip-backend-e2e',
                        id: 536502567,
                        is_template: false,
                        issue_comment_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/comments{/number}',
                        issue_events_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/events{/number}',
                        issues_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues{/number}',
                        keys_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/keys{/key_id}',
                        labels_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/labels{/name}',
                        language: 'TypeScript',
                        languages_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/languages',
                        license: null,
                        merge_commit_message: 'BLANK',
                        merge_commit_title: 'PR_TITLE',
                        merges_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/merges',
                        milestones_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/milestones{/number}',
                        mirror_url: null,
                        name: 'chargetrip-backend-e2e',
                        node_id: 'R_kgDOH_phJw',
                        notifications_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/notifications{?since,all,participating}',
                        open_issues: 2,
                        open_issues_count: 2,
                        owner: {
                            avatar_url: 'https://avatars.githubusercontent.com/u/37342643?v=4',
                            events_url: 'https://api.github.com/users/chargetrip/events{/privacy}',
                            followers_url: 'https://api.github.com/users/chargetrip/followers',
                            following_url: 'https://api.github.com/users/chargetrip/following{/other_user}',
                            gists_url: 'https://api.github.com/users/chargetrip/gists{/gist_id}',
                            gravatar_id: '',
                            html_url: 'https://github.com/chargetrip',
                            id: 37342643,
                            login: 'chargetrip',
                            node_id: 'MDEyOk9yZ2FuaXphdGlvbjM3MzQyNjQz',
                            organizations_url: 'https://api.github.com/users/chargetrip/orgs',
                            received_events_url: 'https://api.github.com/users/chargetrip/received_events',
                            repos_url: 'https://api.github.com/users/chargetrip/repos',
                            site_admin: false,
                            starred_url: 'https://api.github.com/users/chargetrip/starred{/owner}{/repo}',
                            subscriptions_url: 'https://api.github.com/users/chargetrip/subscriptions',
                            type: 'Organization',
                            url: 'https://api.github.com/users/chargetrip',
                        },
                        private: true,
                        pulls_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls{/number}',
                        pushed_at: '2023-02-12T08:32:43Z',
                        releases_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/releases{/id}',
                        size: 790,
                        squash_merge_commit_message: 'BLANK',
                        squash_merge_commit_title: 'PR_TITLE',
                        ssh_url: 'git@github.com:chargetrip/chargetrip-backend-e2e.git',
                        stargazers_count: 0,
                        stargazers_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/stargazers',
                        statuses_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/statuses/{sha}',
                        subscribers_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/subscribers',
                        subscription_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/subscription',
                        svn_url: 'https://github.com/chargetrip/chargetrip-backend-e2e',
                        tags_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/tags',
                        teams_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/teams',
                        topics: [],
                        trees_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/git/trees{/sha}',
                        updated_at: '2022-09-28T08:11:52Z',
                        url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e',
                    ...
                    sha: '45599ca120504112299705943ae8b15d001a4c8f',
                    user: {
                        avatar_url: 'https://avatars.githubusercontent.com/u/37342643?v=4',
                        events_url: 'https://api.github.com/users/chargetrip/events{/privacy}',
                        followers_url: 'https://api.github.com/users/chargetrip/followers',
                ...
                body: 'We had a lot of skipped scenarios which were fixed and unskipped.\r\n\r\nFixes [notion ticket](https://www.notion.so/chargetrip/3d9878391a5a441b80f2ccb905863bc2).\r\n',
                changed_files: 7,
                closed_at: null,
                comments: 4,
                comments_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/42/comments',
                commits: 7,
                commits_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42/commits',
                created_at: '2023-02-10T10:07:49Z',
                deletions: 68,
                diff_url: 'https://github.com/chargetrip/chargetrip-backend-e2e/pull/42.diff',
                draft: false,
                head: {
                    label: 'chargetrip:unskip-station-timeout-scenarios',
                    ref: 'unskip-station-timeout-scenarios',
                    repo: {
                        allow_auto_merge: true,
                        allow_forking: false,
                        allow_merge_commit: false,
                    ...
                    sha: '9295350e75b01bd7a1d8e0c3dd2b10650b583679',
                    user: {
                        avatar_url: 'https://avatars.githubusercontent.com/u/37342643?v=4',
                        events_url: 'https://api.github.com/users/chargetrip/events{/privacy}',
                        followers_url: 'https://api.github.com/users/chargetrip/followers',
                ...
                html_url: 'https://github.com/chargetrip/chargetrip-backend-e2e/pull/42',
                id: 1236436131,
                issue_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/issues/42',
                labels: [],
                locked: false,
                maintainer_can_modify: false,
                merge_commit_sha: '8e400300172288dad4066ec32d78ccb8c67c765b',
                mergeable: true,
                ...
                merged_by: null,
                milestone: null,
                node_id: 'PR_kwDOH_phJ85JsoSj',
                number: 42,
                patch_url: 'https://github.com/chargetrip/chargetrip-backend-e2e/pull/42.patch',
                rebaseable: true,
                requested_reviewers: [
                    {
                        avatar_url: 'https://avatars.githubusercontent.com/u/110375909?v=4',
                        events_url: 'https://api.github.com/users/alexbulearca/events{/privacy}',
                        followers_url: 'https://api.github.com/users/alexbulearca/followers',
                        following_url: 'https://api.github.com/users/alexbulearca/following{/other_user}',
                        gists_url: 'https://api.github.com/users/alexbulearca/gists{/gist_id}',
                        gravatar_id: '',
                        html_url: 'https://github.com/alexbulearca',
                        id: 110375909,
                        login: 'alexbulearca',
                        node_id: 'U_kgDOBpQz5Q',
                        organizations_url: 'https://api.github.com/users/alexbulearca/orgs',
                        received_events_url: 'https://api.github.com/users/alexbulearca/received_events',
                        repos_url: 'https://api.github.com/users/alexbulearca/repos',
                        site_admin: false,
                        starred_url: 'https://api.github.com/users/alexbulearca/starred{/owner}{/repo}',
                        subscriptions_url: 'https://api.github.com/users/alexbulearca/subscriptions',
                        type: 'User',
                        url: 'https://api.github.com/users/alexbulearca',
                    },
                    {
                        avatar_url: 'https://avatars.githubusercontent.com/u/124247681?v=4',
                        events_url: 'https://api.github.com/users/stefan-aneculaesei/events{/privacy}',
                        followers_url: 'https://api.github.com/users/stefan-aneculaesei/followers',
                        following_url: 'https://api.github.com/users/stefan-aneculaesei/following{/other_user}',
                        gists_url: 'https://api.github.com/users/stefan-aneculaesei/gists{/gist_id}',
                        gravatar_id: '',
                        html_url: 'https://github.com/stefan-aneculaesei',
                        id: 124247681,
                        login: 'stefan-aneculaesei',
                        node_id: 'U_kgDOB2fegQ',
                        organizations_url: 'https://api.github.com/users/stefan-aneculaesei/orgs',
                        received_events_url: 'https://api.github.com/users/stefan-aneculaesei/received_events',
                        repos_url: 'https://api.github.com/users/stefan-aneculaesei/repos',
                        site_admin: false,
                        starred_url: 'https://api.github.com/users/stefan-aneculaesei/starred{/owner}{/repo}',
                        subscriptions_url: 'https://api.github.com/users/stefan-aneculaesei/subscriptions',
                        type: 'User',
                        url: 'https://api.github.com/users/stefan-aneculaesei',
                    },
                ],
                requested_teams: [],
                review_comment_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/comments{/number}',
                review_comments: 0,
                review_comments_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42/comments',
                state: 'open',
                statuses_url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/statuses/9295350e75b01bd7a1d8e0c3dd2b10650b583679',
                title: 'fix: unskip station timeout scenarios',
                updated_at: '2023-02-12T08:33:38Z',
                url: 'https://api.github.com/repos/chargetrip/chargetrip-backend-e2e/pulls/42',
                user: {
                    avatar_url: 'https://avatars.githubusercontent.com/u/2368005?v=4',
                    events_url: 'https://api.github.com/users/sebastiancretu/events{/privacy}',
                    followers_url: 'https://api.github.com/users/sebastiancretu/followers',
                    following_url: 'https://api.github.com/users/sebastiancretu/following{/other_user}',
                    gists_url: 'https://api.github.com/users/sebastiancretu/gists{/gist_id}',
                    gravatar_id: '',
                    html_url: 'https://github.com/sebastiancretu',
                    id: 2368005,
                    login: 'sebastiancretu',
                    node_id: 'MDQ6VXNlcjIzNjgwMDU=',
                    organizations_url: 'https://api.github.com/users/sebastiancretu/orgs',
                    received_events_url: 'https://api.github.com/users/sebastiancretu/received_events',
                    repos_url: 'https://api.github.com/users/sebastiancretu/repos',
                    site_admin: false,
                    starred_url: 'https://api.github.com/users/sebastiancretu/starred{/owner}{/repo}',
                    subscriptions_url: 'https://api.github.com/users/sebastiancretu/subscriptions',
                    type: 'User',
                    url: 'https://api.github.com/users/sebastiancretu',
                },
            },
            repository: {
                allow_forking: false,
        ...
        sha: '8e400300172288dad4066ec32d78ccb8c67c765b',
        ref: 'refs/pull/42/merge',
        workflow: 'Notion ticket update',
        action: 'pr-notion-update',
        actor: 'sebastiancretu',
        job: 'notion-update',
        runNumber: 58,
        runId: 4155481991,
    ...
    return {
        ...
        right_delimiter: ')',
        notion: {
            status_property: 'Notion Status',
            pr_property_name: 'Pull Request',
            pr_id_column_name: 'Number',
            pr_state_column_name: 'Name',
            status: state && (0, core_1.getInput)(state, { required: false }),
        },
        pull_request: {
